...
public class DependencyConstraints {
    ...
    private static void addDependencies(Module fromModule, Service service,
    ...
    private static void addDependencies(Module fromModule, Consumer consumer,
            Set<Module> dependencies) {
        for (Service delegate : (List<Service>) consumer
    ...
    private static void addDependencies(Module fromModule,
            DomainObject domainObject, Set<Module> dependencies) {
        ...
        if (domainObject.getRepository() != null) {
            addDependency(fromModule, domainObject.getRepository(),
                    dependencies);
        }
    }

    private static void addDependency(Module fromModule, Repository repository,
            Set<Module> dependencies) {
    ...
    private static void addDependencies(Module fromModule, Reference ref,
            Set<Module> dependencies) {
        if (ref.getTo() == null) {
            return;
        }
    ...
    private static void addDependency(Module fromModule, ServiceOperation op,
            Set<Module> dependencies) {
    ...
    private static void addDependency(Module fromModule,
            DomainObjectTypedElement type, Set<Module> dependencies) {
