...
/**
 * Conversion of English words to plural and singular.
 * By default words become plural by appending -s.
 * Some algorithmic rules are implemented, such as words
 * ending with -y become -ies plural.
 * To be able to handle special cases it is possible to define
 * the mapping in properties file.  
 *
 */
public class SingularPluralConverter {
    ...
    static void init() {
        singular2pluralDefinitions = GeneratorProperties.singular2pluralDefinitions();
