...
/**
 * This class is responsible for mapping of primitive Java 
...
public class PrimitiveTypeMapper {
    ...
    /**
     * Translate primitive type names (such as int, long, boolean) to
     * Object type names (such as Integer, Long, Boolean).
     * If the primitive type is not defined this method will
     * return the primitiveTypeName.
     */
